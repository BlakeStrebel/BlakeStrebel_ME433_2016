...
int main ( void )
{
    ...
    TRISBbits.TRISB4 = 1;   // Pushbutton
    TRISBbits.TRISB13 = 0;  // Motor B direction
    TRISBbits.TRISB9 = 0;   // Motor A direction
    TRISBbits.TRISB15 = 0;  // Motor B PWM
    TRISBbits.TRISB8 = 0;   // Motor A PWM
    ...
    RPB15Rbits.RPB15R = 0b0101;  // use B15 for OC1
    RPB8Rbits.RPB8R = 0b0101;    // use B8 for OC2
    
     // Set up Peripheral Timer2, OC1, OC2
